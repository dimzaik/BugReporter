...
export class BugListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.getAllBugs('','',this.dataPageSize.toString(),this.filterValues.title,this.filterValues.priority,this.filterValues.reporter,this.filterValues.status).subscribe();
  }
